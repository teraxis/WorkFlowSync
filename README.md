...
- Режими: значок в області сповіщень (`--tray`), фоновий процес (`wfs sync --loop`) або завдання
  Планувальника (`wfs sync --once`); автозапуск вмикається перемикачем у «Налаштуваннях».
...
Усі заплановані етапи (0–4) виконано 2026-09-14: каркас, GUI, двигун синхронізації, ретенція й
міграція з FreeFileSync, резидентний режим і автозапуск, трей. План і статус — [docs/requirements.md](docs/requirements.md) §4.
